...
docker pull ${DOCKER_REGISTORY}/nvjdc:latest
log_action_end_msg $?
...
-it --privileged=true  ${DOCKER_REGISTORY}/nvjdc:latest
...
uninstall_nvjdc(){
docker rm -f nvjdc
docker rmi -f ${DOCKER_REGISTORY}/nvjdc:0.4
rm -rf nvjdc
